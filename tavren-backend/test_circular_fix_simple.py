"""
Simplified test script to verify that circular import issues have been fixed.
This version only tests for import errors without initializing FastAPI routes.
"""
import sys
import os
import logging
...
def test_imports():
    """Try importing key modules to test for circular dependencies."""
    try:
        ...
        logger.info("Testing import of app.utils.consent_export...")
        from app.utils import consent_export
        logger.info("✅ Successfully imported app.utils.consent_export")
